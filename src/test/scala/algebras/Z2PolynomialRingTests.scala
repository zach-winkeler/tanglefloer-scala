...
class Z2PolynomialRingTests extends AnyFunSuite {
  ...
  private val x = r("x")
  private val y = r("y")
  private val z = new Z2PolynomialRing.Monomial(r, Map("x" -> 1, "y" -> 1)).toPolynomial
  ...
  private val f = new Z2PolynomialRing.Morphism(r, s, Map("x" -> "u", "y" -> "v"))
  private val g = new Z2PolynomialRing.Morphism(s, r, Map("u" -> "x", "v" -> "y", "w" -> "y"))
